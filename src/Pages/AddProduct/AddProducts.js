    ...
    fetch(
      ...
      .then((result) => {
        if (result.success) {
          ...
          fetch("https://laptop-planet-server.vercel.app//products", {
            method: "POST",
            headers: {
          ...
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="form-control mt-2">
                <input
                  type="text"
                  {...register("usedYear", { required: true })}
            ...
            <div className="mt-2">
              ...
              <input
                type="file"
                className="w-full input input-bordered py-2 "
            ...
            <div className="mt-2 ">
              <textarea
                ...
                cols="30"
                rows="3"
                className="resize-none w-full border border-gray-500 rounded px-5 py-2 text-xl"
