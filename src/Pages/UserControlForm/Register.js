...
const Register = () => {
  ...
  const collectUserInformation = (email, role, name) => {
    ...
    fetch("https://laptop-planet-server.vercel.app//users", {
      method: "POST",
      headers: {
          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-success">
            <div className="card-body">
              <form onSubmit={handleSubmit(handleRegister)}>
                <div className="text-center text-3xl text-black font-mono font-semibold">
                  <h1>Register Now</h1>
                </div>
                ...
                <div>
                  <p className="text-black">
                    ...
                    <Link to="/login" className="text-red-900 link text-xl">
                      Login
                    </Link>
                  </p>
                </div>
